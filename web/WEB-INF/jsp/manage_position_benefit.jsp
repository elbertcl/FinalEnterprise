                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          ...
                          <td>Production</td>
                          <td>Packaging</td>
                          <td><textarea style="height: 80px; width: 100%; resize: none">This is a benefit example. This is a benefit example. This is a benefit example. </textarea></td>
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">Advertisement's Picture</h4>
                            </div>
