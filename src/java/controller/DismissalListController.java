...
public class DismissalListController implements Controller{
    @Override
    public ModelAndView handleRequest(HttpServletRequest hsr, HttpServletResponse hsr1) throws Exception {
        ...
        try {
            ...
            List <Dismiss_Record> dismissrecordList = session.createQuery("from Dismiss_Record").list();
            
            mv.addObject("dismissrecordlist", dismissrecordList);
