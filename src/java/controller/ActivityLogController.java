...
public class ActivityLogController implements Controller{
    @Override
    public ModelAndView handleRequest(HttpServletRequest hsr, HttpServletResponse hsr1) throws Exception {
        ...
        try {
            ...
            List <Activity_Log> activityLog = session.createQuery("from Activity_Log ORDER BY datetime ASC").list();
            
            mv.addObject("activityloglist", activityLog);
